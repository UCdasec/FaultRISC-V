...
int main() {
    ...
    // Store the result of isLowLight function in a variable
    int isLowLightResult = isLowLight(ambientLightLevel, lowLightThreshold);

    // Check the stored result of isLowLight function
    if (isLowLightResult) {
